...
**Exercice: ** Nous avons retracé l'histogramme des valeurs de quantification, en utilisant la fonction `ablines()` pour marquer la moyenne, et arrow pour marquer un intervalle couvrant 1 écart-type de chaque côté de la moyenne. Lisez l'aide des fonctions `abline` et `arrows` en faisant le lien entre les arguments utilisés et le résultat graphique. Ajouter ensuite les instructions pour dessiner également : 
