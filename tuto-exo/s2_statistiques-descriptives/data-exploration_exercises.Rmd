...
utilisez la fonction  R `boxplot()` pour visualiser le tableau de données protéomiques sous forme de boîtes à moustaches. Utilisez différentes options pour rendre cette figure aussi claire que possible. *
