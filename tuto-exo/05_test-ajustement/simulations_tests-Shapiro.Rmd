---
title: "Simulations empiriques : puissance du test de Shapiro"
...
for (n in n_values) {
  ...
  hist(shapiro_pvalues_under_H0, 
       ...
       border="white", 
       main = paste0("Shapiro-Wilk p-values under H0 (normal distribution)", 
                     "\n", "n = ", n,  "; ", repeats, " repeats", 
                     "; Power = ", power),
       las=1
  )
  ...
  hist(shapiro_pvalues_under_H1, 
       ...
       border="white", 
       main = paste0("Shapiro-Wilk p-values under H1 (uniform distribution)", 
                     "\n", "n = ", n,  "; ", repeats, " repeats", 
                     "; Power = ", power),
       las= 1
  )
